...
setup(
    name='tapioca-crunchbase',
    version=get_version(package),
    description='crunchbase API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/vu3jej/tapioca-crunchbase',
    packages=[
        'tapioca_crunchbase',
    ],
    package_dir={'tapioca_crunchbase': 'tapioca_crunchbase'},
